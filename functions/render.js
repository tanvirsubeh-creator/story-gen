  ...
  try {
    ...
    const redditCardHtml = `<html><head><style>
      * { margin:0; padding:0; box-sizing:border-box; }
      ...
      .sub-name { font-size:13px; font-weight:700; color:#d7dadc; }
      .posted-by { font-size:12px; color:#818384; }
      .title-text {
        font-size:18px; font-weight:700; color:#d7dadc;
        line-height:1.4; margin-bottom:14px;
      }
      .vote-row { display:flex; align-items:center; gap:14px; }
      .upvote-btn {
        display:flex; align-items:center; gap:5px;
        background:#272729; border-radius:20px; padding:5px 12px;
        font-size:13px; font-weight:700; color:${genreColor};
      }
      .comments { font-size:13px; color:#818384; }
    </style></head><body>
      <div class="card">
