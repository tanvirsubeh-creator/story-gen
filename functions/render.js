exports.handler = async (event) => {
  ...
  try {
    ...
    // Full-frame Reddit card — Shotstack renders HTML on white by default, which is exactly what we want
    const cardHtml = "<html><head><style>" +
      "* { margin:0; padding:0; box-sizing:border-box; }" +
      "html, body { width:540px; height:960px; background:#ffffff; font-family:-apple-system,'Segoe UI',Arial,sans-serif; }" +
    ...
    // Single track: card first, then word clips
    var clips = [{
